import { PanelPlugin, FieldConfigProperty, NullValueMode } from '@grafana/data';
...
export const plugin = new PanelPlugin<Options>(NotifyGraphPanel)
    .useFieldConfig({
    ...
    .setPanelOptions(builder => {
        builder
            ...
            .addSelect({
                ...
                description: '',
                settings: {
                    options: Object.entries(NullValueMode).map(([value, label]) => ({
            ...
            .addSelect({
                ...
                description: '',
                settings: {
                    options: Object.entries(LegendDisplayMode).map(([value, label]) => ({
                        value: label,
                        label: value as LegendDisplayMode,
                    })),
                },
